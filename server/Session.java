        ...
        try (DataInputStream in = new DataInputStream(new BufferedInputStream(socket.getInputStream()));
            ...
            while (true) {
                ...
                switch (opCode) {
                    ...
                    case OpCodes.ADICIONAR_VENDA:

                        if (currentUser == null){
                            sendResponseBoolean(out, tag, false); break;
                        }
                    ...
                    case OpCodes.QUANTIDADE:

                        if (currentUser==null) {
                            sendResponseInt(out, tag, -1);
                            break;
                        }
                    ...
                    case OpCodes.VOLUME:
                        ...
                        if (currentUser == null) {
                            sendResponseDouble(out, tag, -1.0);
                            break;
                        }
                    ...
                    case OpCodes.GET_EVENTOS:

                        if (currentUser == null) {
                            sendResponseBytes(out, tag, new byte[0]);
                            break;
                        }
